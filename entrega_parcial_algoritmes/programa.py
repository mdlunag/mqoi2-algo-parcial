...
nom_exemplar='ejemplar_p.txt'
nom_solucio='sol_p_08.txt'

#inicialització del temps i extracció de dades del fitxer
temps_inici = time.time()
d=extreure_dades(nom_exemplar)
